...
void Game :: showMatchSummary() {
    ...
    for (int j = 0; j < playersPerTeam; j++) {
        ...
        Player temp = battingTeam->players[j];
        cout << "|----------------------------------------|" << endl;
        cout << "| " << "[" << j << "] " << temp.name << "  \t " << temp.runsScored << "(" << temp.ballsPlayed << ") \t\t " << temp.ballsBowled << "-" << temp.runsGiven << "-" << temp.wicketsTaken << "\t |" << endl;
    }
    cout << "==========================================" << endl << endl;
    ...
    for (int i = 0; i < playersPerTeam; i++) {
        ...
        Player temp = bowlingTeam->players[i];
        cout << "|----------------------------------------|" << endl;
        cout << "| " << "[" << i << "] " << temp.name << "  \t " << temp.runsScored << "(" << temp.ballsPlayed << ") \t\t " << temp.ballsBowled << "-" << temp.runsGiven << "-" << temp.wicketsTaken << "\t |" << endl;
    }
    cout << "==========================================" << endl << endl;
}
